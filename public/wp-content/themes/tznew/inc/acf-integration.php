...
function tznew_register_acf_fields() {
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'sub_fields' => array(
                    ...
                    array(
                        ...
                        'ui' => 1,
                        'return_format' => 'value',
                        'instructions' => 'Select the accommodation type for this day',
                    ),
                    array(
                        'key' => 'field_meals',
                        'label' => 'Meals',
                        ...
                        'ui' => 1,
                        'return_format' => 'value',
                        'instructions' => 'Select the meal plan for this day',
                    ),
                    array(
            ...
            array(
                'key' => 'field_trekking_featured',
                'label' => 'Featured Trek',
                'name' => 'featured',
                'type' => 'true_false',
                'instructions' => 'Mark this trek as featured to highlight it on the website',
                'required' => 0,
                'default_value' => 0,
                'ui' => 1,
                'ui_on_text' => 'Yes',
            ...
            array(
                'key' => 'field_trekking_popular',
                'label' => 'Popular Trek',
                'name' => 'popular',
                'type' => 'true_false',
                'instructions' => 'Mark this trek as popular to show it in popular sections',
                'required' => 0,
                'default_value' => 0,
                'ui' => 1,
                'ui_on_text' => 'Yes',
            ...
            array(
                'key' => 'field_trekking_rating',
                'label' => 'Rating',
                'name' => 'rating',
                'type' => 'number',
                'instructions' => 'Enter the rating for this trek (e.g., 4.8)',
                'required' => 0,
                'default_value' => 4.8,
                'min' => 1,
                'max' => 5,
            ...
            array(
                'key' => 'field_trekking_reviews_count',
                'label' => 'Reviews Count',
                'name' => 'reviews_count',
                'type' => 'number',
                'instructions' => 'Enter the number of reviews for this trek',
                'required' => 0,
                'default_value' => 0,
                'min' => 0,
                'step' => 1,
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'name' => 'featured',
                'type' => 'true_false',
                'instructions' => 'Mark this tour as featured to highlight it on the website',
                'required' => 0,
                'default_value' => 0,
                'ui' => 1,
                'ui_on_text' => 'Yes',
            ...
            array(
                'key' => 'field_tour_popular',
                'label' => 'Popular Tour',
                'name' => 'popular',
                'type' => 'true_false',
                'instructions' => 'Mark this tour as popular to show it in popular sections',
                'required' => 0,
                'default_value' => 0,
                'ui' => 1,
                'ui_on_text' => 'Yes',
            ...
            array(
                ...
                'name' => 'rating',
                'type' => 'number',
                'instructions' => 'Enter the rating for this tour (e.g., 4.8)',
                'required' => 0,
                'default_value' => 4.8,
                'min' => 1,
                'max' => 5,
            ...
            array(
                'key' => 'field_tour_reviews_count',
                'label' => 'Reviews Count',
                'name' => 'reviews_count',
                'type' => 'number',
                'instructions' => 'Enter the number of reviews for this tour',
                'required' => 0,
                'default_value' => 0,
                'min' => 0,
                'step' => 1,
...
/**
 * Register ACF fields for Region taxonomy
 */
function tznew_register_region_taxonomy_fields() {
    if (!function_exists('acf_add_local_field_group')) {
        return;
    }
    ...
    acf_add_local_field_group(array(
        'key' => 'group_region_fields',
        'title' => 'Region Details',
        'fields' => array(
            array(
                'key' => 'field_region_coordinates',
                'label' => 'Region Coordinates',
                'name' => 'region_coordinates',
                'type' => 'group',
                'instructions' => 'Enter the central coordinates for this region',
                'sub_fields' => array(
                    array(
                        'key' => 'field_region_latitude',
                        'label' => 'Latitude',
                        'name' => 'latitude',
                        'type' => 'text',
                        'instructions' => 'Enter latitude (e.g., 28.0000) - Optional',
                        'required' => 0,
                        'placeholder' => '28.0000',
                    ),
                    array(
                        'key' => 'field_region_longitude',
                        'label' => 'Longitude',
                        'name' => 'longitude',
                        'type' => 'text',
                        'instructions' => 'Enter longitude (e.g., 85.0000) - Optional',
                        'required' => 0,
                        'placeholder' => '85.0000',
                    ),
                ),
            ...
            array(
                'key' => 'field_region_show_on_map',
                'label' => 'Show on Regional Adventure Map',
                'name' => 'show_on_map',
                'type' => 'true_false',
                'instructions' => 'Toggle to show/hide this region polygon on the front page map',
                'required' => 0,
                'default_value' => 1,
                'ui' => 1,
                'ui_on_text' => 'Show',
            ...
            array(
                'key' => 'field_region_description',
                'label' => 'Region Description',
                'name' => 'region_description',
                'type' => 'textarea',
                'instructions' => 'Brief description of this region for map tooltips',
                'required' => 0,
                'rows' => 3,
            ),
            array(
                'key' => 'field_region_image',
                'label' => 'Region Image',
                'name' => 'region_image',
                'type' => 'image',
                'instructions' => 'Upload an image to represent this region',
                'required' => 0,
                'return_format' => 'array',
                'preview_size' => 'medium',
                'library' => 'all',
            ...
            array(
                'key' => 'field_region_color',
                'label' => 'Map Polygon Color',
                'name' => 'polygon_color',
                'type' => 'color_picker',
                'instructions' => 'Choose color for this region\'s polygon on the map',
                'required' => 0,
                'default_value' => '#3388ff',
            ),
            array(
                'key' => 'field_polygon_coordinates',
                'label' => 'Polygon Coordinates',
                'name' => 'polygon_coordinates',
                'type' => 'textarea',
                'instructions' => 'JSON data for polygon coordinates (managed by Region Manager)',
                'required' => 0,
                'readonly' => 1,
                'rows' => 5,
            ),
            array(
                'key' => 'field_assigned_trekking',
                'label' => 'Assigned Trekking',
                'name' => 'assigned_trekking',
                'type' => 'post_object',
                'instructions' => 'Select trekking posts assigned to this region',
                'required' => 0,
            ...
            array(
                'key' => 'field_assigned_tours',
                'label' => 'Assigned Tours',
                'name' => 'assigned_tours',
                'type' => 'post_object',
                'instructions' => 'Select tour posts assigned to this region',
                'required' => 0,
...
add_action('acf/init', 'tznew_register_region_taxonomy_fields');
